          ...
          <ul class="nav navbar-nav">
           ...
           <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo site_url('assets/users/klien/'.$this->session->userdata('foto')) ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $this->session->userdata('name');?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo site_url('assets/users/klien/'.$this->session->userdata('foto')) ?>" class="img-circle" alt="User Image">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo site_url('klien_profile') ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
